...
class AmenityTest(unittest.TestCase):
    ...
    def test_5_kwargs(self):
        ...
        Mod1 = Amenity(id=my_id, created_at=actual_date,
                       updated_at=actual_date, __class__='Amenity',
                       test='my_test')
        self.assertTrue(isinstance(Mod1, Amenity))
    ...
    def test_6_User_class(self):
        ...
        self.assertTrue(type(my_model_0) == Amenity)
