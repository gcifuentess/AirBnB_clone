...
class CityTest(unittest.TestCase):
    ...
    def test_5_kwargs(self):
        ...
        Mod1 = City(id=my_id, created_at=actual_date,
                    updated_at=actual_date, __class__='City',
                    test='my_test')
        self.assertTrue(isinstance(Mod1, City))
    ...
    def test_6_City_class(self):
        ...
        self.assertTrue(type(my_model_0) == City)
    ...
    def test_8_City_type_args(self):
        '''If object args are of the correct type'''

        my_model_0 = City()

        attbs = storage.class_attributes()['City']
